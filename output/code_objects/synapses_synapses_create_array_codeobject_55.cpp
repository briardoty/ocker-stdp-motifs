...
void _run_synapses_synapses_create_array_codeobject_55()
{
...
const int _numtargets = 17;
const int _numsources = 17;
...
const int _num_presynaptic_idx = _dynamic_array_synapses__synaptic_pre.size();
 ...
 int32_t* __restrict  _ptr_array_synapses_targets_55 = _array_synapses_targets_55;
 int32_t* __restrict  _ptr_array_synapses_sources_55 = _array_synapses_sources_55;
...
for (int _idx=0; _idx<_numsources; _idx++) {
    ...
    const int32_t sources = _ptr_array_synapses_sources_55[_idx];
    const int32_t targets = _ptr_array_synapses_targets_55[_idx];
