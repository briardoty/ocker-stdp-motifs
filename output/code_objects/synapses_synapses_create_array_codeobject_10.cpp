...
void _run_synapses_synapses_create_array_codeobject_10()
{
...
const int _num_presynaptic_idx = _dynamic_array_synapses__synaptic_pre.size();
 ...
 int32_t* __restrict  _ptr_array_synapses_targets_10 = _array_synapses_targets_10;
 int32_t* __restrict  _ptr_array_synapses_sources_10 = _array_synapses_sources_10;
...
for (int _idx=0; _idx<_numsources; _idx++) {
    ...
    const int32_t sources = _ptr_array_synapses_sources_10[_idx];
    const int32_t targets = _ptr_array_synapses_targets_10[_idx];
